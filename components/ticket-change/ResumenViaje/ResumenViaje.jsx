      ...
      <div className={styles["contenedor-servicios"]}>
        ...
        <div className={ styles['total-container'] }>
          ...
          <div className={ styles['contanedor-total-pagar'] }>
            <span className={ styles['valor-boleto'] }>Valor boleto anterior: { clpFormat.format(Number(boletoValido['valor'])) }</span>
            <span className={ styles['valor-boleto'] }>Valor boleto nuevo: { clpFormat.format(totalPagar) }</span>
            <span className={ styles['total-pagar'] }>Total a pagar: { clpFormat.format(totalPagar - Number(boletoValido['valor'])) }</span>
          </div>
        ...
        <div className={ styles['contenedor-boton-pagar'] }>
          <button className={ styles['boton-pagar'] } onClick={ () => sendToPayment() }>
            { totalPagar - Number(boletoValido['valor']) === 0 ? 'Continuar' : 'Pagar' }
          </button>
