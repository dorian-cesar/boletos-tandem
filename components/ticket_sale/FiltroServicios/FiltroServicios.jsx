...
export const FiltroServicios = (props) => {
  ...
  return (
    <div
      key={stage + "it"}
      className={`shadow-sm d-flex flex-col bg-white px-3 py-3 pt-1 rounded-4 gap-2 ${styles["custom-shadow"]}`}
    >
      {/* <div id="petFilter">
                <h3>Filtrar por:</h3>
      ...
      <div id="serviceSchedule" className="d-flex flex-col mt-2">
        ...
        <div className="d-flex flex-col gap-1 mt-1">
          ...
          <div className="custom-control custom-checkbox">
            ...
            />
            <label className="custom-control-label" htmlFor="horaCheck4">
