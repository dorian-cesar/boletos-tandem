...
const StagePago = (props) => {
    ...
    async function sendToPayment() {
        try {
            ...
            const { data } = await axios.post('/api/ticket_sale/guardar-carro', new GuardarCarroDTO(email, rut, getTotal(), pasajes));
    ...
    return (
        <main className={ styles['main-content'] }>
            <section>
                <Acordeon title='Resumen de compra' content='Contenido del acordeon' />
            </section>
