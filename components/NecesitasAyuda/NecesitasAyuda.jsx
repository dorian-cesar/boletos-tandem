...
const NecesitasAyuda = (props) => {
  ...
  function setDataConsulta({ name, value }) {
    try {
      ...
      console.error(`Error al agregar informacion de la consulta [${message}]`);
    }
  }
  ...
  const guardarSolicitud = async () => {
    ...
    try {
      const res = await axios.post("/api/parametros/guardar-solicitud-ayuda", 
        consulta,
      );
      if (res.data.status) {
        setTipoMostrar("OK");
                      ...
                      <div className={"row"}>
                        <div className={"col"}>
                          ...
                          <input
                            ...
                            onChange={(e) => setDataConsulta(e.target)}
                          />
                        </div>
                      </div>
                      <div className={"row"}>
