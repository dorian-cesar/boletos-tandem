        ...
        <>
          <div className="row">
            <div className="d-flex justify-content-center">
              <div className="container-perfil col-12 col-md-8 bloque flex-column">
                <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-3 text-center top">
          ...
          <div className="row">
            <div className="d-flex justify-content-center">
              <div className="col-12 col-md-2 bloque flex-column">
