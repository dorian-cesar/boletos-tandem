...
const TeAyudamos = (props) => {
  ...
  function vistaPreguntasFrecuente(){
    setStage(1)
  }
          ...
          <div className="d-flex justify-content-center">
            <div className="col-12 col-md-5">
              ...
              >
                ...
                <div className={""}>
                  <div className={styles["button"]} onClick={() => { vistaPreguntasFrecuente() }}>
            ...
            <div className="col-12 col-md-5">
              ...
              >
                ...
                <div className={""}>
                  <div className={styles["button"]}>Habla con Nosotros</div>
                </div>
              </div>
            </div>
          </div>
          <div className="d-flex justify-content-center">
            ...
            <div className="col-12 col-md-5">
              <div className={`${styles["other-body"]}  `}>
                ...
                <div className={"row"}>
                  <div className={"col-12"}>
                    <span className={styles["text-bold"]}>Call Center</span> | Lunes a viernes: 09:00AM - 18:00PM <br />
