...
import styles from "./RespuestaTransaccionCanje.module.css";
...
export default function Home(props) {
  ...
  const cambioRespuesta = useSelector((state) => state.compra);
      ...
      {respuestaCambio ? (
        <>
          <section className={styles["main-section"]}>
            ...
            Tu compra se ha realizado con éxito. Próximamente, recibirás un correo electrónico con los boletos adquiridos.
            </span>
